...
public class RESTService extends IntentService {
    ...
    public static final String EXTRA_HTTP_VERB       = "net.neilgoodman.android.rest.EXTRA_HTTP_VERB";
    public static final String EXTRA_PARAMS          = "net.neilgoodman.android.rest.EXTRA_PARAMS";
    public static final String EXTRA_RESULT_RECEIVER = "net.neilgoodman.android.rest.EXTRA_RESULT_RECEIVER";
    
    public static final String REST_RESULT = "net.neilgoodman.android.rest.REST_RESULT";
