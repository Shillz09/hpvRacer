...
public class LapsContentProvider extends ContentProvider {
  ...
  // database
  private LapsDatabaseHelper database;
  ...
  static {
    sURIMatcher.addURI(AUTHORITY, BASE_PATH, LAPS);
    sURIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", LAP_ID);
  }

  @Override
  public boolean onCreate() {
    database = new LapsDatabaseHelper(getContext());
    return false;
  }
  ...
  public Cursor query(Uri uri, String[] projection, String selection,
    ...
    // Set the table
    queryBuilder.setTables(LapsTable.TABLE_LAPS);
    ...
    case LAP_ID:
      ...
      queryBuilder.appendWhere(LapsTable.COLUMN_ID + "="
  ...
  public Uri insert(Uri uri, ContentValues values) {
    ...
    switch (uriType) {
    case LAPS:
      id = sqlDB.insert(LapsTable.TABLE_LAPS, null, values);
      break;
    default:
      throw new IllegalArgumentException("Unknown URI: " + uri);
    }
  ...
  public int delete(Uri uri, String selection, String[] selectionArgs) {
    ...
    switch (uriType) {
    case LAPS:
      rowsDeleted = sqlDB.delete(LapsTable.TABLE_LAPS, selection,
          selectionArgs);
      break;
    case LAP_ID:
      String id = uri.getLastPathSegment();
      if (TextUtils.isEmpty(selection)) {
        rowsDeleted = sqlDB.delete(LapsTable.TABLE_LAPS,
  ...
  public int update(Uri uri, ContentValues values, String selection,
    ...
    switch (uriType) {
    case LAPS:
      rowsUpdated = sqlDB.update(LapsTable.TABLE_LAPS, 
          values, 
          selection,
          selectionArgs);
      break;
